...
class Res2Net(nn.Module):
    ...
    def forward(self, x):
        ...
        layer1 = self.layer1(x)  # torch.Size([1, 256, 88, 88])
        layer2 = self.layer2(layer1)  # torch.Size([1, 512, 44, 44])
...
def res2net50_v1b_26w_4s(pretrained=False, **kwargs):
    ...
    #     model.load_state_dict(model_zoo.load_url(model_urls['res2net50_v1b_26w_4s']))
    if pretrained:
        model_state = torch.load('/home/user/COD/Data/pretrained_model/res2net50_v1b_26w_4s-3cf99910.pth')
